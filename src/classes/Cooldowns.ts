import CooldownTypes from '../enums/CooldownTypes';
import cooldownSchema from '../models/cooldown-schema';
import type { InternalCooldownConfig, CooldownConfig } from '../types/cooldown';
...
class Cooldowns {
	...
	canRunAction(cooldownUsage: InternalCooldownConfig) {
		const {
			cooldownType,
			userId,
			actionId,
